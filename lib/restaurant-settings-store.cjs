...
const DEFAULT_SITE_APPEARANCE_SETTINGS = Object.freeze({
  ...
  platformFooter: {
    ...
    logo: DEFAULT_PLATFORM_FOOTER.logo || "./assets/inovas-food-logo-oficial.png",
    ...
    url: DEFAULT_PLATFORM_FOOTER.url || "https://inovasfood.com.br",
    displayUrl: DEFAULT_PLATFORM_FOOTER.displayUrl || "inovasfood.com.br",
  },
});
  ...
  schemaReadyPromise = (async () => {
    if (
      await assertMigrationManagedRelations({
        sql,
        relations: ["restaurant_settings"],
        component: "configuracoes do restaurante",
      })
    ) {
      return;
    }
...
const normalizePlatformFooter = (
  ...
  return {
    ...
    logo: normalizeAssetUrl(source.logo, fallback.logo || "./assets/inovas-food-logo-oficial.png"),
