...
const { IDENTIFIERS } = require("./app-branding.cjs");
const { getRequestHeader } = require("./http.cjs");

const CUSTOMER_COOKIE_NAMES = IDENTIFIERS.cookieNames || {};
const CUSTOMER_HEADER_NAMES = IDENTIFIERS.headerNames || {};
const CUSTOMER_SESSION_COOKIE_NAME =
  CUSTOMER_COOKIE_NAMES.customerSession || "tokyo_customer_session";
const CUSTOMER_SESSION_TTL_SECONDS = 60 * 60 * 24 * 7;
const CUSTOMER_LOGIN_CHALLENGE_COOKIE_NAME =
  CUSTOMER_COOKIE_NAMES.customerLoginChallenge || "tokyo_customer_login_challenge";
const CUSTOMER_LOGIN_CHALLENGE_TTL_SECONDS = 60 * 10;
const CUSTOMER_CLIENT_TOKEN_HEADER =
  CUSTOMER_HEADER_NAMES.customerClientToken || "x-tokyo-customer-client-token";
const CUSTOMER_KEY_HEADER = CUSTOMER_HEADER_NAMES.customerKey || "x-tokyo-customer-key";
