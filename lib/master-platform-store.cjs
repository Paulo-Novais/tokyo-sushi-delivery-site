...
const getDefaultPlatformSettings = () => ({
  ...
  site: "https://inovasfood.com.br",
  domain: "inovasfood.com.br",
  email: "",
  emails: {
    support: "",
    financial: "",
...
const createRestaurantOnboarding = async (payload = {}, actor = {}) => {
  ...
  if (!restaurantKey || restaurantKey === RESTAURANT_KEY) {
    throw buildOnboardingHttpError(
      ...
      "Slug/restaurantKey do restaurante piloto é inválido."
    );
  }
  ...
  const restaurant = normalizeRestaurant({
    ...
    onboarding: {
      ...
      menuAddress:
        restaurantPayload.menuAddress && typeof restaurantPayload.menuAddress === "object"
